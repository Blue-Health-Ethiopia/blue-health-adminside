...
export const EditButton = ({ icon, placeholder }) => {
  return (
    <div>
      <button
        className={`text-end hover:bg-primaryLight bg-primary duration-150 rounded-lg p-2 fap text-white font-light capitalize tracking-[0.3rem] text-xs w-full`}
      >
        <div
...
export const CopyButton = ({ icon, placeholder }) => {
  return (
    <div>
      <button
        className={`text-end hover:bg-primaryLight hover:text-white bg-transparent border border-primary  duration-150 rounded-lg p-1 text-primary font-light capitalize tracking-[0.3rem] text-xs w-full`}
      >
        <div
