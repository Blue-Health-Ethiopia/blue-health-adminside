...
function Button({ placeholder, icon,activeRoute,isExpanded }) {
  return (
    <div>
      <button className={` p-4 text-end hover:bg-primaryLight ${activeRoute?'bg-primaryMedium':'bg-primaryDark'} duration-150 rounded-lg p-3 text-white font-extralight capitalize tracking-[0.3rem] text-xs w-full`}>
