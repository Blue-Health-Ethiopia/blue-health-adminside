  ...
  return (
    <div className='h-screen w-auto bg-background flex justify-center items-center'>
     ...
     <img src={logo} alt="" className='w-52'/>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col pl-7 pr-7 mt-3 align-middle'>
      <input 
      type="text"
      ...
      <button className='border-2 font-bold text-xl text-primary transition-all mt-9 m-3 border-primary h-10 hover:bg-primary hover:border-none hover:text-white'>Login</button>
      </form>
      </div>
    </div>
  )
